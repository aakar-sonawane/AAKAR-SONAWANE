...
| Project | Description |
|---|---|
| 🌾 **[KhetiMitra](https://github.com/aakar-sonawane/KhetiMitra)** | Multi-model AI farming assistant combining ML-based crop recommendation, disease risk prediction, and real government-data-driven location recommendation — wrapped in an LLM chatbot (Groq → Gemini fallback) with a light/dark chat UI. |
